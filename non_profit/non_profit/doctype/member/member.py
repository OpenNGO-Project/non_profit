...
def get_or_create_membership_for_member(
	...
	*,
	...
	membership_type_amount = frappe.db.get_value("Membership Type", membership_type, "amount")
...
def _membership_active_on(membership, reference_date) -> bool:
	...
	return (not from_date or from_date <= reference_date) and (not to_date or to_date >= reference_date)
